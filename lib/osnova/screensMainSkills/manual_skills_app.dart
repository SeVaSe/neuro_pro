...
import 'package:neuro_pro/osnova/screensMainSkills/topic_detail_skills.dart';
import '../../assets/colors/app_colors.dart';

class ManualSkillsApp extends StatefulWidget {

  const ManualSkillsApp({Key? key}) : super(key: key); // Обновите конструктор

  @override
  _ManualSkillsApp createState() => _ManualSkillsApp();
}

class _ManualSkillsApp extends State<ManualSkillsApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          AppStrings.buttonStartManualSkillsString,
          style: TextStyle(
